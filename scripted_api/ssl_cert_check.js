...
sslChecker(url, 'GET', 443).then(result => assert.ok(result.daysRemaining > failDaysBeforeExpiration, "the certificate will expire in the next " + result.daysRemaining + " days."));